...
while True:
    ...
    if not '_{}_{}'.format(titular,numero) in extrato.keys:
        extrato['_{}_{}'.format(titular,numero)] = []
    ...
    if servico == 'deposito' or servico == 'saque':
        ...
        if not '_{}_{}_deposito'.format(titular,numero) in list(extrato.keys()):
            extrato['_{}_{}_deposito'.format(titular,numero)] = []
        if not '_{}_{}_saque'.format(titular,numero) in list(extrato.keys()):
            extrato['_{}_{}_saque'.format(titular,numero)] = []
        ...
        extrato['_{}_{}_{}'.format(titular,numero, servico)].append(valor)

    elif servico == 'extrato':
        c.imprimir_extrato(extrato, dados)
